...
import {cleanHtml, cleanIntroHtml} from './galley.mjs';
...
const introCache=path.join(cache,'intro.json');
const introHtml=fs.existsSync(introCache)?JSON.parse(fs.readFileSync(introCache,'utf8')).html:null;
